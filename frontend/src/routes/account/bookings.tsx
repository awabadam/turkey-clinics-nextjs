        ...
        {bookingsList.length === 0 ? (
          <Card>
            <CardContent className="flex flex-col items-center justify-center py-12">
              ...
              <Button asChild>
                <Link to="/" search={{ city: undefined, search: undefined, services: undefined, languages: undefined, minRating: undefined, sortBy: 'newest', page: undefined }}>Browse Clinics</Link>
              </Button>
            </CardContent>
          </Card>
        ) : (
                  ...
                  <div className="flex items-start justify-between">
                    <div>
                      <CardTitle className="flex items-center gap-2">
                        <Link
                          to="/clinics/$slug"
                          params={{ slug: booking.clinic.slug }}
