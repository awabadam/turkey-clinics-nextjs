...
export const Route = createFileRoute('/admin/clinic-requests')({
  component: ClinicRequestsPage,
});
...
interface PendingClinic {
  ...
  city: string;
  phone: string;
  email: string; // from owner relation usually, but clinic model has email too
  createdAt: string;
  status: string;
  owner: {
    email: string;
