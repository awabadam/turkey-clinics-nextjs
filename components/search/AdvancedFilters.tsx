...
export default function AdvancedFilters() {
  ...
  useEffect(() => {
    ...
    setSelectedServices(searchParams.get("services")?.split(",").filter(Boolean) || []);
    setSelectedLanguages(searchParams.get("languages")?.split(",").filter(Boolean) || []);
  ...
  useEffect(() => {
    const timer = setTimeout(() => {
      ...
      if (params.languages) urlParams.set("languages", params.languages);
    ...
    return () => clearTimeout(timer);
  }, [selectedCity, searchQuery, selectedServices, selectedLanguages, minRating, sortBy, router]);
